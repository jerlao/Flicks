...
class NowPlayingTableViewController: UITableViewController, NSURLSessionDelegate, UISearchBarDelegate {
    ...
    func fadeInImage(imageUrl: NSURL, cell: NowPlayingTableViewCell)-> NowPlayingTableViewCell {
